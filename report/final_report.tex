...
\author{%
  Aryan Rafsanjany \quad\quad Hasin Ishrak \quad\quad Himel Hasan \\
  Department of Computer Science and Engineering \\
  BRAC University, Dhaka, Bangladesh \\
  \texttt{\{aryan.rafsanjany, hasin.ishrak, himel.hasan\}@g.bracu.ac.bd} \\
  \vspace{0.3em}
  \textbf{Code \& Models:} \url{https://github.com/Hasinish/MUSIC-CONTEXT-AI}
}
